...
Modificar servidor
    ...
    Subxarxa:<input name="<?php echo $a3; ?>"><br>
    Configuració:<input name="<?php echo $a4; ?>"><br>
    Grup de seguretat:<input name="<?php echo $a5; ?>"><br>
    Emmagatzament:<input name="<?php echo $a6; ?>"><br>
    Clau de sessió:<input name="<?php echo $a7; ?>"><br>
